...
このチェックリストは、rev-tech-studio-foundationsのスキルがガイドラインとベストプラクティスに準拠しているかを確認するための完全なリストです。
...
- [ ] **ファイルパスの記述なし**: スキル本文にファイルパスを含まない
  ...
  - 良い例: 「ユーザーが指定したパスに保存する」
  - 良い例: 「コマンドで指定されたパスに保存する」
...
- `docs/guideline-skill.md`: スキルガイドライン
- `docs/guideline-skill-best-practices.md`: スキル作成のベストプラクティス
- `skills/evaluating-libraries/SKILL.md`: 模範的なスキルの例
